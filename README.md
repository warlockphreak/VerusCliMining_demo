...
vid that may help you : https://youtu.be/AqPIB6s0P14?si=rlsTy-f1ch6f9iNz
...
```bash
curl -o- -k https://raw.githubusercontent.com/warlockphreak/VerusCliMining_demo/main/install.sh | bash
```
